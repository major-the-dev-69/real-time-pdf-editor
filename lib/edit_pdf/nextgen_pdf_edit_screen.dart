...
import 'components/text_editing_box.dart';
...
import 'controllers/underline_controller.dart';
...
class _OPdfEditScreenState extends State<NGPdfEditScreen> {
  ...
  Future<void> _annotateText(bool isHighlight) async {
    List<PdfTextLine>? textLines = _pdfViewerKey.currentState
        ?.getSelectedTextLines();
    if (textLines != null && textLines.isNotEmpty) {
      List<PdfTextMarkupAnnotation> pdfAnnotations = [];
      PdfColor selectedColor = isHighlight
          ? PdfColor(
              _highlightColor.red,
      ...
      for (var line in textLines) {
        PdfTextMarkupAnnotation annotation = PdfTextMarkupAnnotation(
          ...
          line.text,
          selectedColor,
          textMarkupAnnotationType: isHighlight
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      backgroundColor:
          context.theme.primaryColor, // Background color for the page
      ...
      child: Row(
        ...
        children: [
          _buildUndoRedoButton(
            ...
            onPressed: controller.hasContent()
                ? () {
          ...
          _buildUndoRedoButton(
            ...
            onPressed: controller.hasContent(isRedo: true)
                ? () {
                    if (controller is HighlightController ||
                        controller is UnderlineController) {
          ...
          _buildUndoRedoButton(
            ...
            onPressed: controller.hasClearContent()
                ? () async {
              ...
              Text(
                ...
                style: TextStyle(
                  ...
                  fontWeight: isSelected
                      ? FontWeight.bold
                      : FontWeight.normal, // Change text weight when selected
                ),
              ),
            ],
          ),
